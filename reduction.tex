...
the energy transfer to fine scales, averaged over the window; states
...
$L^2$, an obstruction to collapse onto a fixed steady Euler profile; and
...
good time in the sense above, the inertial dissipation of
\cite{DucRob00} at fixed $\nu$. It is not the
...
multiple of its radius; and a pressure outside $L^2$ on every terminal
interval. These conditions are necessary, not sufficient.
...
every scale finer than some fixed one, however fine. The first
